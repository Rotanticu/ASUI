...
namespace ASUI
{
        ...
        where TAdapter : unmanaged, IMotionAdapter<TValue, TOptions>
    {
        ...
        {
            //this.AnimationDriver = motionBuilder;
        }
        ...
        // public LitMotionAdapter(Component target, TValue start, TValue end, float duration, MotionType motionType, Action onComplete = null)
        // {
        ...
        // public LitMotionAdapter(TValue start, TValue end, float duration, Action<TValue> onUpdate, Action onComplete = null)
        // {
        //     this.startTValue = start;
        //     this.endTValue = end;
        //     this.motionDuration = duration;
        ...
        // public LitMotionAdapter<TValue> WithEase(Ease ease)
        // {
